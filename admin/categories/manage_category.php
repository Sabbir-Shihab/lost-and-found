					...
					<form action="" id="category-form">
						...
						<div class="row">
							<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
								...
								<textarea rows="3" name="description" id="description" class="form-control form-control-sm rounded-0 tinymce-editor"><?php echo isset($description) ? $description : ''; ?></textarea>
							</div>
						</div>
						<div class="row">
							<div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
	...
	$(document).ready(function(){
		$('#category-form').submit(function(e){
			...
			if(!$('#description').val().trim()){
				var el = $('<div>')
					el.addClass("alert alert-danger err-msg").text('Description is required.')
					_this.prepend(el)
				el.show('slow')
